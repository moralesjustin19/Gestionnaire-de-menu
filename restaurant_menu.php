    ...
    <header>
        <section>
            <div class="header">
                ...
                <path
                d="M110 34.8997C118.513 39.4198 125.582 45.921 130.497 53.75C135.412 61.579 138 70.4598 138 79.5L82 79.5L110 34.8997Z"></path>
                </mask>
                <path
                ...
                stroke="#EE9758"
                stroke-width="2"
                mask="url(#path-1-inside-1_7_2)"></path>
                </g>
                <g id="pepperoni">
